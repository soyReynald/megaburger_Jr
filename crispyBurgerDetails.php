  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="section section-md bg-default">
        <div class="container">
          <h3 class="oh-desktop"><span class="d-inline-block wow slideInDown">Cispy Burger</span></h3>
          <div class="row row-md row-30">
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Services Terri-->
                <article>
                  <div><img src="images/CrackBurgerDetails.jpg" alt="" width="370" height="278"/></div>
                </article>
              </div>
            </div>
            <div class="col-sm-6 col-lg-6">
                <div class="oh-desktop">
                  ...
                  <article style="padding-left: 20px;">
                    ...
                    <p style="text-align: start;">Un desafío para los paladares más exigentes. Nuestra hamburguesa cuádruple es una montaña de carne y queso que te dejará sin aliento. Cuatro jugosas patties de carne a la parrilla se apilan, separadas por generosas porciones de queso cheddar derretido y crujiente tocino. Para darle un toque extra de sabor, hemos añadido cebolla caramelizada, que aporta una dulzura y una textura inigualable. Todo esto, sobre un pan brioche suave y tostado, que soporta esta creación culinaria digna de los amantes de las hamburguesas más atrevidas.</p>
                    <h6 style="padding-top: 25px; text-align: start;">Ingredientes</h7>
                      <!-- "text-decoration: none; font-weight: normal; " -->
                    <ul style="padding-top: 20px; padding-bottom: 20px; color: #777777; text-transform: capitalize; font-family: Roboto; font-weight: normal;">
                        <li>Pan de sesamo</li>
                        <li>4 patties de carne de res molida</li>
                        <li>Queso cheddar</li>
                        <li>Tocino</li>
                        <li>cebolla caramelizada</li>
                    </ul>
                    <h7 style="color: #777777;">Opcionales</h7>
                    <ul style="padding-top: 20px; color: #777777; text-transform: capitalize; font-family: Roboto; font-weight: normal;">
                        <li>Salsa BBQ ahumada</li>
                        <li>Mostaza antigua </li>
